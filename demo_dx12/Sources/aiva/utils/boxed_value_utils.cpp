...
void aiva::utils::BoxedValueUtils::InitializeTypeMapper()
{
	...
	RegisterTypeMapper<glm::u8mat4>(EBoxedType::UINT8X4X4);
	...
	RegisterTypeMapper<glm::i8mat4>(EBoxedType::INT8X4X4);
	...
	RegisterTypeMapper<glm::u16mat4>(EBoxedType::UINT16X4X4);
	...
	RegisterTypeMapper<glm::i16mat4>(EBoxedType::INT16X4X4);
	...
	RegisterTypeMapper<glm::u32mat4>(EBoxedType::UINT32X4X4);
	...
	RegisterTypeMapper<glm::i32mat4>(EBoxedType::INT32X4X4);
	...
	RegisterTypeMapper<glm::u64mat4>(EBoxedType::UINT64X4X4);
	...
	RegisterTypeMapper<glm::i64mat4>(EBoxedType::INT64X4X4);
	...
	RegisterTypeMapper<glm::f32mat4>(EBoxedType::FLOAT32X4X4);
	...
	RegisterTypeMapper<glm::f64mat4>(EBoxedType::FLOAT64X4X4);
}
