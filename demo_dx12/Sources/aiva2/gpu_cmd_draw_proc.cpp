...
namespace aiva2
{
    ...
    auto gpu_cmd_draw_proc_t::get_property_block_ptr() const->std::shared_ptr<material_property_block_t const> const&
    {
        return m_property_block;
    }

    auto gpu_cmd_draw_proc_t::get_property_block_ref() const->material_property_block_t const&
    {
    ...
    void gpu_cmd_draw_proc_t::set_property_block_ptr(std::shared_ptr<material_property_block_t const> const& property_block)
    {
