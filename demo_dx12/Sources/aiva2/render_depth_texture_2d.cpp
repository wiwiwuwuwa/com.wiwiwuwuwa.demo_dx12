...
namespace aiva2
{
	render_depth_texture_2d_t::render_depth_texture_2d_t(engine_t& engine, std::shared_ptr<tex_2d_t> const& resource, render_depth_texture_2d_info_t const& info /*= {}*/)
		: impl_type{ engine }
		, m_resource{ resource }
		, m_info{ info }
	{
	...
	void render_depth_texture_2d_t::init_state_for_transition() const
	{
		...
		auto const subresource_index = tex_2d_utils_t::get_subresource_index((*m_resource), m_info);
	...
	auto render_depth_texture_2d_t::get_resource() const->std::shared_ptr<tex_2d_t> const&
	{
		return m_resource;
	}
