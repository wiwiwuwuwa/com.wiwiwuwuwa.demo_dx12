...
namespace aiva2
{
	struct render_depth_texture_2d_t final : public implements_t<render_depth_texture_2d_t, render_texture_base_t>
	{
		// ------------------------------------------------

	public:
		render_depth_texture_2d_t(engine_t& engine, std::shared_ptr<tex_2d_t> const& resource, render_depth_texture_2d_info_t const& info = {});
