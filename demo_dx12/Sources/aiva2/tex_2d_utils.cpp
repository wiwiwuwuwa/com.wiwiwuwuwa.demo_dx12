...
namespace aiva2
{
	...
	size_t tex_2d_utils_t::get_subresource_index(tex_2d_t const& resource, render_color_texture_2d_info_t const& info)
	{
		return get_subresource_index(resource, info.get_mip_slice(), info.get_plane_slice());
	}

	size_t tex_2d_utils_t::get_subresource_index(tex_2d_t const& resource, render_depth_texture_2d_info_t const& info)
	{
