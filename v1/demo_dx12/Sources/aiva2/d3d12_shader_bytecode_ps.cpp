...
namespace aiva2
{
    d3d12_shader_bytecode_ps_t::d3d12_shader_bytecode_ps_t(shader_info_t const& shader_info)
    {
        init_bytecode(shader_info);
    }

    d3d12_shader_bytecode_ps_t::~d3d12_shader_bytecode_ps_t()
    {
        shut_bytecode();
    }

    auto d3d12_shader_bytecode_ps_t::get_data() const->D3D12_SHADER_BYTECODE
    {
    ...
    void d3d12_shader_bytecode_ps_t::init_bytecode(shader_info_t const& shader_info)
    {
		...
		(
			...
			/*pDefines*/ {},
			/*pInclude*/ {},
			/*pEntrypoint*/ shader_info.get_meta_block().get_entry_for_frag().c_str(),
			/*pTarget*/ "ps_5_1",
			/*Flags1*/ {},
			/*Flags2*/ {},
    ...
    void d3d12_shader_bytecode_ps_t::shut_bytecode()
    {
        assert_t::check_bool(m_bytecode, "(m_bytecode) is not valid");
        m_bytecode = {};
    }
