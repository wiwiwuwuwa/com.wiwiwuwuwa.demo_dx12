...
namespace aiva2
{
    d3d12_shader_bytecode_vs_t::d3d12_shader_bytecode_vs_t(shader_info_t const& shader_info)
    {
        init_bytecode(shader_info);
    }

    d3d12_shader_bytecode_vs_t::~d3d12_shader_bytecode_vs_t()
    {
        shut_bytecode();
    }

    auto d3d12_shader_bytecode_vs_t::get_data() const->D3D12_SHADER_BYTECODE
    {
    ...
    void d3d12_shader_bytecode_vs_t::init_bytecode(shader_info_t const& shader_info)
    {
		...
		(
			...
			/*pDefines*/ {},
			/*pInclude*/ {},
			/*pEntrypoint*/ shader_info.get_meta_block().get_entry_for_vert().c_str(),
			/*pTarget*/ "vs_5_1",
			/*Flags1*/ {},
			/*Flags2*/ {},
    ...
    void d3d12_shader_bytecode_vs_t::shut_bytecode()
    {
        assert_t::check_bool(m_bytecode, "(m_bytecode) is not valid");
        m_bytecode = {};
    }
